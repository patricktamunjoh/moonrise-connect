...
namespace MoonriseGames.CloudsAhoyConnect
{
    public static class Invocation
    {
        ...
        public static void Invoke(Action function) => Session.Instance?.Emitter.Call(function);
        ...
        public static void Invoke<T1>(Action<T1> function, T1 p1) => Session.Instance?.Emitter.Call(function, p1);
        ...
        public static void Invoke<T1, T2>(Action<T1, T2> function, T1 p1, T2 p2) => Session.Instance?.Emitter.Call(function, p1, p2);
        ...
        public static void Invoke<T1, T2, T3>(Action<T1, T2, T3> function, T1 p1, T2 p2, T3 p3) => Session.Instance?.Emitter.Call(function, p1, p2, p3);
        ...
        public static void Invoke<T1, T2, T3, T4>(Action<T1, T2, T3, T4> function, T1 p1, T2 p2, T3 p3, T4 p4) => Session.Instance?.Emitter.Call(function, p1, p2, p3, p4);
    }
}
