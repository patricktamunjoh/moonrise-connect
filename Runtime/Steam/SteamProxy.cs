...
namespace MoonriseGames.CloudsAhoyConnect.Steam {
    internal class SteamProxy {
        ...
        public virtual void ClosePeerToPeerConnection(HSteamNetConnection connection) =>
            SteamNetworkingSockets.CloseConnection(connection, 0, string.Empty, false);
        ...
        public virtual ConnectionStatusChangedCallback CreateConnectionStatusChangedCallback(
            ConnectionStatusChangedCallback.DispatchDelegate callback
