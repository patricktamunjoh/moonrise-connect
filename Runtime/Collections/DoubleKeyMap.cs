...
namespace MoonriseGames.CloudsAhoyConnect.Collections {
    ...
    internal class DoubleKeyMap<TKey1, TKey2, TValue> {
        ...
        public TValue this[TKey1 key1, TKey2 key2] { get => Read(key1, key2); set => Write(key1, key2, value); }
        ...
        private TValue Read(TKey1 key1, TKey2 key2) {
            if (!Map.TryGetValue(key1, out var inner)) inner = new Dictionary<TKey2, TValue>();
            return inner[key2];
        }
    }
}
