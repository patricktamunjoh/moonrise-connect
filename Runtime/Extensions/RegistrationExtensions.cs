...
namespace MoonriseGames.CloudsAhoyConnect.Extensions {
    public static class RegistrationExtensions {
        ...
        public static GameObject Register(this GameObject target, bool doRegisterChildObjects = false) {
            CloudsAhoyConnect.Instance?.Registry.RegisterGameObject(target, doRegisterChildObjects);
            return target;
        }
        ...
        /// <param name="doRegisterChildObjects">When true, all child objects in the hierarchy are registered as well.</param>
        public static T RegisterGameObject<T>(this T target, bool doRegisterChildObjects = false) where T : Component {
            CloudsAhoyConnect.Instance?.Registry.RegisterGameObject(target.gameObject, doRegisterChildObjects);
            return target;
        }
        ...
        public static T RegisterInstance<T>(this T target) where T : class {
            CloudsAhoyConnect.Instance?.Registry.RegisterObject(target);
            return target;
        }
        ...
        public static T UnregisterInstance<T>(this T target) where T : class {
            CloudsAhoyConnect.Instance?.Registry.UnregisterObject(target);
            return target;
        }
    }
}
