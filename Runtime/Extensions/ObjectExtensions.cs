...
namespace MoonriseGames.CloudsAhoyConnect.Extensions {
    internal static class ObjectExtensions {
        ...
        public static IEnumerable<GameObject> ChildGameObjects(this GameObject target) =>
            target.GetComponentsInChildren<Transform>().Skip(1).Select(x => x.gameObject);
