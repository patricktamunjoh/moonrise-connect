    ...
    internal class NetworkFunctionDelegate {
        ...
        public virtual void Invoke(object[] arguments) {
            ...
            if (arguments?.Length == 0) {
                const string message = @"The provided array of arguments is empty. 
            ...
            if ((arguments?.Length ?? 0) != Data.ParameterTypes.Length) {
                const string message = @"The provided array of arguments does not have the expected length. 
        ...
        public virtual string ToString(object[] arguments) {
            if (!TargetReference.TryGetTarget(out var target)) return string.Empty;
